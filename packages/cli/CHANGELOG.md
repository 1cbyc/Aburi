...
- c64fccb: Look for the IR where a scan would have written it, from the working directory upward
...
- 9ae0126: Let the config decide `respectGitignore` when neither flag was typed
...
- 304e659: Read `config.output.dir`, which three documents call the default for `--output-dir`
